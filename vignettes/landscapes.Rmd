...
Those readers interested in systems with 3 or more state variables can find a generalization of these results in section \@ref(generalization-to-an-arbitrary-number-of-dimensions) of the online appendix.
...
## Generalization to an arbitrary number of dimensions
