...
And, if $\ref{eq:anyDcond}$ holds, the potential is given by equation $\ref{eq:anyDint}$, where the line integral is computed along the curve $\Gamma$ joining the points $\vec x_0$ and $\vec x$.
