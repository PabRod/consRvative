...
(ref:penrose) The Penrose stair, a classical example of an impossible object. In this surface, it is possible to walk in a closed loop while permanently going downhill. This kind of surfaces were popularized by the Dutch artist M.C. Escher (for a beautiful example, see @escher).
