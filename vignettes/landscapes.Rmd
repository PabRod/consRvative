...
\begin{equation}
\label{eq:TaylorExp}
\vec f(\vec x)^t = \vec f(\vec{x_0})^t + J(\vec{x_0}) \cdot \Delta \vec x^t + \mathcal{O} \left( \| \vec x \| ^2 \right)
\end{equation}
...
\vec f(\vec x)^t = \vec f(\vec{x_0})^t + J_{Symm}(\vec{x_0}) \cdot \Delta \vec x^t + J_{Skew}(\vec{x_0}) \cdot \Delta \vec x^t+ \mathcal{O} \left( \| \vec x \| ^2 \right)
\end{equation}
...
\vec f(\vec x)^t = - \vec \nabla V(\vec{x})^t + J_{Skew}(\vec{x_0}) \cdot \Delta \vec x^t + \mathcal{O} \left( \| \vec x \| ^2 \right)
\end{equation}
...
\begin{equation}
\label{eq:Potential}
V(\vec{x})^t = V(\vec{x_0})^t - \vec f(\vec x_0) \cdot \Delta \vec x^t - \frac{1}{2} \Delta \vec x \cdot J_{Symm} (\vec{x_0}) \cdot \Delta \vec x^t + \mathcal{O} \left( \| \vec x \| ^3 \right)
\end{equation}
