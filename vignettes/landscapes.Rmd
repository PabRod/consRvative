...
The gradient term can thus be associated to a potential $V(\vec x)$, whose shape can be computed analytically using a line integral (see \@ref(eq:vecInt)). The result of this integration yields a relationship between the value of the potential at two points \@ref(eq:Potential).
